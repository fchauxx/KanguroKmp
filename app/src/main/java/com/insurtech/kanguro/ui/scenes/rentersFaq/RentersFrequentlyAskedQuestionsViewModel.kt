...
@HiltViewModel
class RentersFrequentlyAskedQuestionsViewModel @Inject constructor(
    private val advicesRepository: IAdvicesRepository
) : BaseViewModel() {

    private val _uiState =
        MutableStateFlow<UiState<RentersFaqModel>>(UiState.Loading.ScreenLoader)
